...
Simulating Syngo FastView series for CTCA slices:
`77172526 → 77172537 → 77172548 → 77172559 → 77172570`

---

### 1. Coronary Lumen & Plaque

| Vessel / Segment | Stenosis | Plaque Type | Density | Status |
|---|---|---|---|---|
| Left Main (LM) | 0% — CAD-RADS 0 | None | 320 HU | Patent, homogeneous |
| **pLAD — proximal** | **17.3% — CAD-RADS 2** | Minimal Calcified, Ecc 0.78 | 450 HU (420–510 core) | Eccentric calcification, plaque arc 140°, RI 1.08 |
| Left Circumflex (LCx) | 0% — CAD-RADS 0 | None | 315 HU | Normal patent pathway |
| mRCA — mid segment | 12.1% — CAD-RADS 1 | Minimal Soft Lipid, Ecc 0.44 | 65 HU (40–80 pool) | Minor wall thickening, non-obstructive, RI 1.04 |

Syngo slices (pLAD): `77172537 · 77172548 · 77172559 · 77172570 · 77172581`
Syngo slices (mRCA): `77172603 · 77172614 · 77172625 · 77172636 · 77172647`

---

### 2. Perivascular FAI — Inflammation Profiling

| Vessel | FAI Value | Threshold | Status | Clinical Note |
|---|---|---|---|---|
| **pLAD** | **-68.4 HU** | -70.1 HU | ⚠️ **BORDERLINE ELEVATED** | Above threshold — pericoronary inflammation signal detected. Independent MACE risk modifier. |
| mRCA | -76.1 HU | -70.1 HU | ✅ NEGATIVE | Within normal epicardial adipose HU range. No inflammatory signal. |

> ⚠️ **FAI Clinical Note:** pLAD FAI of **-68.4 HU** exceeds the validated **-70.1 HU threshold** (Oikonomou et al., 2018). This finding was absent from the original CAD-RADS 1 report and is the most significant new finding. FAI elevation is associated with **9× increased fatal cardiac event risk** independent of stenosis grade alone.

---

### 3. Calcium Burden & Risk Stratification

| Vessel | Agatston | Volume mm³ | Segment |
|---|---|---|---|
| Left Main | 0 | 0.0 | — |
| Left Ant. Descending | 42 | 31.4 | pLAD |
| Left Circumflex | 0 | 0.0 | — |
| Right Coronary Artery | 8 | 6.1 | mRCA |
| **TOTAL** | **50** | **37.5** | ~45th percentile, 71yr male |

> Total Agatston **50** — mild burden. Primary preventive protocol indicated. No invasive diagnostics warranted by calcium alone.

---

### 4. Ventricular Geometry & Valve

| Parameter | Value | Normal Range (71yr M) | Status |
|---|---|---|---|
| LV Wall Thickness | 11.2 mm | 6–11 mm | ⚠️ Upper limit |
| RV Wall Thickness | 4.1 mm | 2–5 mm | ✅ Normal |
| LV Volume | 142.3 ml | 100–160 ml | ✅ Normal |
| Estimated EF | 58.2% | 55–70% | ✅ Normal preserved EF |
| LV Mass Index | 102.1 g/m² | < 102 g/m² | ⚠️ Borderline |
| Mitral Valve | Trace regurg. (Gr 0-1) | None / Trace | ✅ Intact |

---

### 5. Revised Classification

**CAD-RADS™ 2 + FAI MODIFIER**
*Minimal-to-mild non-obstructive CAD | Elevated pericoronary inflammatory risk modifier*

Upgraded from CAD-RADS 1 → CAD-RADS 2 on basis of:
- (a) Geometric pLAD stenosis 17.3%, plaque arc 140°, remodelling index 1.08
- (b) pLAD FAI -68.4 HU above -70.1 HU threshold — independent MACE modifier
- (c) Borderline LV mass index 102.1 g/m²

**Actionable Strategies:**
1. Initiate/intensify primary preventive protocol (statin + lifestyle) based on FAI elevation and mild plaque profiles
2. Serial CTCA re-assessment in **2–3 years** to monitor pLAD FAI trajectory and plaque progression
3. Borderline LV mass index warrants blood pressure optimisation review
4. No high-tier invasive diagnostics (FFR-CT, invasive angiography) indicated

> ⚕ *SIMULATION ONLY — NOT FOR DIAGNOSTIC USE. Generated by HERMES Clinical Ensemble v2.0 · Pipeline: MONAI + Med-SAM2 + nnU-Net v2 + TotalSegmentator*
