...
def render():
    ...
    with col1:
        animate = st.toggle("Animate finding dots", key="ctca_panel_viewer_animate", value=False)
    with col2:
        show_labels = st.toggle("Show slice labels", key="ctca_panel_viewer_labels", value=True)
    with col3:
