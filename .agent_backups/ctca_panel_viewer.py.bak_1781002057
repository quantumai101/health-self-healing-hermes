...
def render():
    ...
    with col1:
        animate = st.toggle("Animate finding dots", key="ctca_panel_viewer_animate", value=False, key="ctca_animate_toggle")
    with col2:
        show_labels = st.toggle("Show slice labels", key="ctca_panel_viewer_labels", value=True, key="ctca_labels_toggle")
    with col3:
